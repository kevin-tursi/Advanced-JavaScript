...
function willIGetHired(answer) {
    var affirmation;
    switch (answer) {
        case 'yes':
            affirmation = 'you got this ho';
            break;
        case 'if i work hard':
            affirmation = 'i will succeed';
            break;
        case 'you\'re god damn right motherfucker':
            affirmation = 'you know it boss';
            break;
        default:
            affirmation = 'hype yourself up';
    }
    return affirmation;
}